  ...
  const onSubmit: SubmitHandler<FormData> = async (formData) => {
    try {
      ...
      if (response.token) {
        ...
        localStorage.setItem('userDetails', JSON.stringify({ user_id: response.user.user_id, token: response.token, role: response.user.role, contact_phone: response.user.contact_phone }));
